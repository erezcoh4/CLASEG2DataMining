...
ShiftL_a1   = np.linspace(0.4   ,0.8    ,3)
shfLa2      = ShiftL_a2 = 0


if (flags.verbose > 1): print "running %d runs "%int(len(SigmaT)*len(SigmaL_a1)*len(SigmaL_a2)*len(ShiftL_a1))
