...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TCalcPhysVarsEG2*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TCalcPhysVarsEG2", "TCalcPhysVarsEG2.h", 27,
...
class __attribute__((annotate("$clingAutoload$TAnalysisEG2.h")))  TVector3;
namespace std{inline namespace __1{template <class _Tp> class __attribute__((annotate("$clingAutoload$string")))  allocator;
}}
class __attribute__((annotate("$clingAutoload$TAnalysisEG2.h")))  TLorentzVector;
class __attribute__((annotate("$clingAutoload$TAnalysisEG2.h")))  TEG2dm;
