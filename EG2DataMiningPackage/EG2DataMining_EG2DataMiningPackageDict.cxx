...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::T3pSimulation*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("T3pSimulation", "T3pSimulation.h", 27,
                  typeid(::T3pSimulation), DefineBehavior(ptr, ptr),
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TLorentzVector>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<TLorentzVector>", -2, "TLorentzVectorDict.h", 8,
