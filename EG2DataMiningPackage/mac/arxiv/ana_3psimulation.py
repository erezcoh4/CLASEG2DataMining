...
if (Operation == "protons in the process"):
    ...
    c.cd(13)
    ana.H2("p_knocked_r.P()" ,"p1_ppPair_r.P()" , cut,"colz",50, 0., 3, 50, 0.2, 1, "p-knocked, after re-scattering vs. p-1 after re-scattering" , "p_{knocked} after [GeV/c]", "p_{1} re-scatterd [GeV/c]" )
    c.cd(14)
    ana.H2("p_knocked.P()" ,"Pmiss.P()" , cut,"colz",50, 1., 3, 50, 0., 1, "p-knocked, before re-scattering vs. p(miss)" , "p_{knocked} before [GeV/c]", "|p_{miss}| [GeV/c]" )
    c.cd(14)
    ana.H2("p_knocked_r.P()" ,"Pmiss.P()" , cut,"colz",50, 0., 3, 50, 0., 1, "p-knocked, after re-scattering vs. p(miss)" , "p_{knocked} after [GeV/c]", "|p_{miss}| [GeV/c]" )
    c.cd(15)
    ana.H2("Plead.P()" ,"Pmiss.P()" , cut,"colz",50, 0., 3, 50, 0., 1, "'leading' proton vs. p(miss)" , "|p_{lead}| [GeV/c]", "|p_{miss}| [GeV/c]" )
    c.Update()
