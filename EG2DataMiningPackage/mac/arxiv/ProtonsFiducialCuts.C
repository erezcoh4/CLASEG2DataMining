bool ProtonsFiducialCuts(){
    ...
    anaTree->Draw(str_var+">>h","Pmiss.P()>0.3 && Pmiss.P()<1");
    ...
    h->GetXaxis()->SetTitle("#theta_{p} [deg.]");
    h->GetYaxis()->SetTitle("#phi_{p} [deg.]");
    c->SaveAs("/Users/erezcohen/Desktop/Projects/2NSRC/CLASppCMnote/Figures/ProtonFiducialCuts.png");
