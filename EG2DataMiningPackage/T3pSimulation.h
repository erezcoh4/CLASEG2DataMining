...
public:
    ...
    TTree   * kinematics_tree;
    TF1     * SRCk4Tail;
    TH1F    * hCFG ;
    TH2F    * h_q , * h_ppElastic;
    
    Int_t       binEcm      , Np        , rand_kin_entry        , N_kin_entries;
    ...
    Float_t     Px_e        , Py_e      , Pz_e      , Pe        , Ee  , omega ;
    ...
    TLorentzVector Beam , e , q , struck_p , p_knocked , p1_ppPair , pcm_ppPair , p2_ppPair;
    ...
    void     Imp_kinematics ( TTree * kin_tree , bool DoPlot = false );
