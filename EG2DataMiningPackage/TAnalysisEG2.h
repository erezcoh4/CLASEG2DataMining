...
public:
    ...
    TCut    ppNothingCut, ppSRCCutFiducial;
    ...
    std::vector<Double_t>   RooFitCM_1bin (Float_t PmissMin, Float_t PmissMax, bool DoWeight = false, bool PlotFits = false, int debug = 0, TCanvas * c = nullptr);
    std::vector<Double_t>   FastRooFitCM_1bin (Float_t PmissMin, Float_t PmissMax );
